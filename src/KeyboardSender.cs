...
namespace ShadowConsil.src
{
    public class KeyboardSender
    {
        ...
        public void Trigger(System.Windows.Forms.Keys key, bool shift = false, bool ctrl = false, bool alt = false)
        {
            ...
            NativeMethods.PostMessage(hWndEdit, NativeMethods.WM_KEYDOWN, key, IntPtr.Zero);
        }
    }
}
